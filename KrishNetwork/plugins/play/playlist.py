...
from KrishNetwork import Carbon, app
from KrishNetwork.utils.decorators.language import language, languageCB
from KrishNetwork.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
...
from KrishNetwork.core.mongo import mongodb
...
async def add_playlist(client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from KrishNetwork import YouTube
...
@app.on_callback_query(filters.regex("krish_playlist") & ~BANNED_USERS)
@languageCB
